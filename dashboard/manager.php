...
.krow{display:grid;grid-template-columns:repeat(auto-fit,minmax(145px,1fr));gap:12px;margin-bottom:18px;}
    ...
    <div class="cright">
        ...
        <div class="card">
            ...
            <div class="qagl">
                ...
                <a class="qa" href="compliance.php"><div class="qi">&#128203;</div><div class="ql">My SLAs</div></a>
