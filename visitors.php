...
?>
<style>
.vpage{max-width:960px;margin:0 auto;padding:24px 16px 40px;display:grid;grid-template-columns:1fr 320px;gap:18px;align-items:start;overflow-y:auto;height:100%;min-height:0;}
